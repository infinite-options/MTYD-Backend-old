...
> **Note**: For testing purpose, we have to use testing credit card which is listed on stripe's website: https://stripe.com/docs/testing - automatic!
...
**There are still some endpoints have not completed yet. We will update when we have it tested.**
